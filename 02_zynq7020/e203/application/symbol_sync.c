...
POINT_TYPE R_SEQUENCE[WIN_LEN/8] = { 0 }      ;   // ���յ������� 
// POINT_TYPE P_SEQUENCE[WIN_LEN] = { 0 }      ;   // ���ش洢��P����
u32        Ep                  =   66365394/8 ;   // ����һ��ʼ�ͼ��������
  
u16        index_              = 0          ;   // index_ ��ԭ���� index��һ���ڽ�����
u16        symbol_judg_count   = 0          ;    

float32    symbol_judg         = 0.0        ;  

u8         SYMBOL_THRS         = 0.6;   
float32    SYMBOL_JUGE_THRS    = 8          ;   // �о�����
u32        Pn                  = 0;
u32        Er                  = 0;
int        now_index           = 0;
